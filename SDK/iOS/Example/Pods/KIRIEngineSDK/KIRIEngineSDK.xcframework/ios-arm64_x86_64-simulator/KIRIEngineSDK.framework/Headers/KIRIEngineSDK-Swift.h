...
#ifndef KIRIENGINESDK_SWIFT_H
#define KIRIENGINESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KIRIEngineSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13KIRIEngineSDK34AVCapturePhotoCaptureProxyDelegate")
...
SWIFT_CLASS("_TtC13KIRIEngineSDK12CaptureModel")
@interface CaptureModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13KIRIEngineSDK17ImageCaptureModel")
@interface ImageCaptureModel : CaptureModel
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13KIRIEngineSDK24AdvanceImageCaptureModel")
...
SWIFT_CLASS("_TtC13KIRIEngineSDK11CaptureView")
...
SWIFT_CLASS("_TtC13KIRIEngineSDK9SceneView")
