...
You can build and test a full APl integration with KIRI Engine using Test Mode. Any account created in Test Mode wil
interact with your test mode stored data.
